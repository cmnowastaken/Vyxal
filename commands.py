...
command_dict = {
    ...
    "⟑": (
        "rhs, lhs = pop(stack, 2); stack.append(vectorise(lambda x, y: x and y, lhs, rhs))",
        2,
    ),
    "∨": ("rhs, lhs = pop(stack, 2); stack.append(lhs or rhs)", 2),
    "⟇": (
        "rhs, lhs = pop(stack, 2); stack.append(vectorise(lambda x, y: x or y, lhs, rhs))",
        2,
    ),
    ...
    "D": (
        "lhs = pop(stack); stack.append(lhs); stack.append(deref(lhs)), stack.append(deref(deref(lhs)))",
        1,
    ),
    ...
    "o": ("rhs, lhs = pop(stack, 2); stack.append(remove(lhs,rhs))", 2),
    "p": ("rhs, lhs = pop(stack, 2); stack.append(prepend(lhs,rhs))", 2),
